 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZendX_JQuery_View_Helper_SimpleTag extends ZendX_JQuery_View_Helper_UiWidget
{
    /**
     ...
     * @return String
     */
    public function simpleTag($id, $value = null, array $params = array(), array $attribs = array())
    {
        ...
        if (!isset($params['source'])) {
            if (isset($params['url'])) {
                ...
                throw new ZendX_JQuery_Exception(
                    "Cannot construct SimpleTag field without specifying 'source' field, ".
